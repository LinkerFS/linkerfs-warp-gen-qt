...
#ifndef LINKERFS_WARP_GEN_QT_DIRATTRIBUTE_HPP
#define LINKERFS_WARP_GEN_QT_DIRATTRIBUTE_HPP
...
public:
     ...
     */
    QList<QPair<QString, bool>> dirList;
};

#endif //LINKERFS_WARP_GEN_QT_DIRATTRIBUTE_HPP