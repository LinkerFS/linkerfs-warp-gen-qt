...
#ifndef LINKERFS_WARP_GEN_QT_RESPONSESTATUS_HPP
#define LINKERFS_WARP_GEN_QT_RESPONSESTATUS_HPP
enum ResponseStatus {
    ResponseStatus_OK = 200,
    ResponseStatus_Fail = 500
};

#endif //LINKERFS_WARP_GEN_QT_RESPONSESTATUS_HPP