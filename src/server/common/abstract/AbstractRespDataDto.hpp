...
#ifndef LINKERFS_WARP_GEN_QT_ABSTRACTRESPDATADTO_HPP
#define LINKERFS_WARP_GEN_QT_ABSTRACTRESPDATADTO_HPP

#include <QJsonValue>
#include <QJsonObject>
#include <QJsonArray>

class AbstractRespDataDto {
public:
    virtual QJsonValue toJsonValue() = 0;
};

#endif //LINKERFS_WARP_GEN_QT_ABSTRACTRESPDATADTO_HPP